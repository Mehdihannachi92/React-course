...
const greeting1 = createGreeting("mehdi");
...
const [firstName, lastName] = ["Mehdi", "Hannachi"];
...
console.log(person.name); // prints 'mehdi'
...
const {name} = myObj;
console.log(name); // prints 'mehdi'
console.log(age); // prints undefined
console.log(myObj); // prints {name: 'mehdi', age: 32}
...
printName({name: 'mehdi', age: 32}); // prints 'mehdi'
